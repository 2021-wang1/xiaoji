      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="内容标题" prop="neirongbiaoti">
            <el-input v-model="ruleForm.neirongbiaoti" placeholder="内容标题" clearable :readonly="ro.neirongbiaoti"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="内容标题" prop="neirongbiaoti">
              <el-input v-model="ruleForm.neirongbiaoti" placeholder="内容标题" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="完成内容" prop="wanchengneirong">
            <el-input
              ...
              placeholder="完成内容"
              clearable
              :readonly="ro.wanchengneirong"
            ></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="完成内容" prop="wanchengneirong">
              <el-input v-model="ruleForm.wanchengneirong" placeholder="完成内容" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="24">
        ...
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item class="input" v-if="ruleForm.tijiaoriqi" label="提交日期" prop="tijiaoriqi">
              <el-input v-model="ruleForm.tijiaoriqi" placeholder="提交日期" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
